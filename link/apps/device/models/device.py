...
class Device(BaseModel):
    ...
    category = models.ForeignKey("device.DeviceCategory", null=True, blank=True, related_name='devices',
                                 verbose_name='所属分类', on_delete=models.SET_NULL, db_constraint=False)
