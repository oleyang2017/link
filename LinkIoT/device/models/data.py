...
class DataSet(models.Model):
    ...
    stream_id = models.CharField(max_length=16, verbose_name='数据流', db_index=True)  # 这里不和stream模型做建立关联,目的是便于日后使用时序数据库
    client_id = models.CharField(max_length=16, verbose_name='设备', db_index=True)  # 同上
